...
abstract class $CarsCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String car_color, String price, bool availability});
}
...
class _$CarsImpl implements _Cars {
  ...
  @override
  String toString() {
    return 'Cars(id: $id, car_color: $car_color, price: $price, availability: $availability)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, car_color, price, availability);
